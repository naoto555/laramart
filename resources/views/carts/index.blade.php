...
<div class="container d-flex justify-content-center mt-3">
    <div class="w-75">
        ...
        <form method="post" action="{{route('carts.destroy')}}" class="d-flex justify-content-end mt-3">
            ...
            <a href="/" class="btn laravelmart-favorite-button border-dark text-dark mr-3">
                買い物を続ける
            </a>
            @if ($total > 0)
            <div class="btn laravelmart-submit-button" data-toggle="modal" data-target="#buy-confirm-modal">購入を確定する</div>
            @else
            <div class="btn laravelmart-submit-button disabled" data-toggle="modal" data-target="#buy-confirm-modal">購入を確定する</div>
            @endif
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn laravelmart-favorite-button border-dark text-dark" data-dismiss="modal">閉じる</button>
