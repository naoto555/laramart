            ...
            <form method="POST" action="/users/mypage">
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show userName">
                        <h1 class="laravelmart-edit-user-info-value">{{ $user->name }}</h1>
                    </div>
                    <div class="collapse editUserName">
                        ...
                        <button type="submit" class="btn laravelmart-submit-button mt-3 w-25">
                            保存
                        </button>
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show userMail">
                        <h1 class="laravelmart-edit-user-info-value">{{ $user->email }}</h1>
                    </div>
                    <div class="collapse editUserMail">
                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email" autofocus placeholder="laravel@laravel.com">
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show userPhone">
                        <h1 class="laravelmart-edit-user-info-value">{{ $user->phone }}</h1>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn laravelmart-delete-submit-button text-white">退会する</button>
                                </div>
                            </div>
                        </div>
                    </div>
