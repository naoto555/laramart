...
<div class="w-75">
    ...
    <form method="POST" action="/dashboard/products/import/csv" class="form-inline" enctype="multipart/form-data">
        ...
        <div class="d-flex flex-column">
            <div class="d-flex flex-row">
                <label for="product-import-csv" class="btn laravelmart-button mr-3">CSVファイルを選択</label>
                <input type="file" name="csv" id="product-import-csv" style="display: none;" onChange="handleCSV(this.files)">
                <button class="btn laravelmart-submit-button">一括登録</button>
            </div>
    ...
    <div class="d-flex justify-content-between mt-3">
        ...
        <a class="btn laravelmart-button" href="{{ asset('csv/products.csv') }}">雛形ファイルダウンロード</a>
    </div>
