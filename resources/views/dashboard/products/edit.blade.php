...
<div class="w-50">
    ...
    <form method="POST" action="/dashboard/products/{{ $product->id }}" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="form-inline mt-4 mb-4 row">
            ...
            <img src="{{ Storage::disk('s3')->url($product->image) }}" id="product-image-preview">
            @else
        ...
        <div class="form-inline mt-4 mb-4 row">
            ...
            <input type="checkbox" name="recommend" id="product-recommend" class="laravelmart-check-box" checked>
            @else
            <input type="checkbox" name="recommend" id="product-recommend" class="laravelmart-check-box">
            @endif
        </div>
        <div class="form-inline mt-4 mb-4 row">
        ...
        <div class="d-flex justify-content-end">
            <button type="submit" class="w-25 btn laravelmart-submit-button">更新</button>
        </div>
    </form>
